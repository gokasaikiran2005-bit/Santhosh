...
interface EditSectionTitleModalProps {
  isOpen: boolean;
  onClose: () => void;
  currentTitle: string;
...
const EditSectionTitleModal: React.FC<EditSectionTitleModalProps> = ({ isOpen, onClose, currentTitle, onSave, modalTitle }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <label htmlFor="section-title" className="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">
            Title
          </label>
          <input
            type="text"
...
export default EditSectionTitleModal;
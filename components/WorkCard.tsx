...
const WorkCard: React.FC<WorkCardProps> = ({ work, companyName, onClick }) => {

    const handleCardClick = (e: React.MouseEvent) => {
        // Prevent click handler from firing if an external link is clicked
    ...
    return (
        <div
            className={`group relative rounded-2xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl hover:shadow-accent/20 cursor-pointer ${aspectRatioClass}`}
